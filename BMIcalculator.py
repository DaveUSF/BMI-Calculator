...
app_name = Label(top_frame, text = "BMI Calculator",width=23, height=1, padx=0, anchor="center", font=("Ivy 16 "),bg=co1,fg=co0)
...
l_weight = Label(down_frame, text = "Enter your weigth", height = 1, padx=0, anchor="Center",font=("Ivy 10 bold"), bg=col, fg=co0)
l_weight.grid(row=1, column=0, columnspan=1, pady=10, padx=3)
e_weight = Entry(down_frame,width=5, font=("Ivy 10 bold"), justify="center",relief=SOLID)
e_weight.grid(row=1, column=1, columnspan=1, pady=10, padx=3)

l_height = Label(down_frame, text = "Enter your weigth", height = 1, padx=0, anchor="Center",font=("Ivy 10 bold"), bg=col, fg=co0)
...
l_result_text = Label(down_frame, width=37, text="", height=1, padx=6, pady=12, anchor="center", font=('Ivy 24 bold'),bg=co2,fg=co1)
l_result.text.place(x=0, y=85)
